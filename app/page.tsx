    ...
    <div className="relative min-h-screen bg-white text-zinc-900">
      <div className="relative overflow-hidden bg-zinc-100">
        ...
        <section className="relative z-10 min-h-[100svh] pt-4 sm:pt-0">
          <div className="relative z-10 mx-auto grid min-h-[100svh] w-full max-w-6xl grid-cols-1 items-start gap-8 px-4 pb-10 pt-4 sm:gap-12 sm:px-6 sm:pb-16 sm:pt-2 md:items-center md:pt-3 lg:grid-cols-2 lg:gap-16 xl:gap-24">
            <motion.div
              aria-hidden
            ...
            <motion.div
              className="order-1 w-full max-w-xl text-center sm:max-w-2xl sm:text-right lg:absolute lg:left-6 lg:top-[34%] lg:z-[12] lg:w-[min(52vw,640px)] lg:max-w-none lg:text-left xl:left-10"
              variants={stagger}
              initial="hidden"
              animate="show"
            >
